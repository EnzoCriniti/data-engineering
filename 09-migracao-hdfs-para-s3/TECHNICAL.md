...
O capítulo 09 mostra que a evolucao para object storage raramente acontece em um ambiente vazio. A camada física de storage também precisa lidar com legado, migracao, custo, latência e continuidade operacion